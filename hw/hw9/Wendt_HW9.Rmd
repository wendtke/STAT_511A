...
See results in Part 3A. The 95% confidence interval for the odds ratio is 1.61, 3.17. Because 0 is not included in the confidence interval, we can conclude there is evidence to suggest a relationship between bird ownership and lung cancer. 
